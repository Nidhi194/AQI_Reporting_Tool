...
function generateProfessionalPDF() {
    ...
    const cssStyles = `
        <style>
            ...
            body { font-family: 'Inter', sans-serif; padding: 40px; color: #1e293b; background: white; margin: 0; line-height: 1.6; }
            ...
            .section-title { font-size: 18px; color: #0284c7; border-bottom: 1px solid #cbd5e1; padding-bottom: 5px; margin-bottom: 15px; }
